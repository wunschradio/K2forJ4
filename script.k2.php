...
class Com_K2InstallerScript
{
	...
	public function update($type)
	{
		...
		$query = "ALTER TABLE #__k2_attachments CHANGE `hits` `hits` INT(11) NOT NULL DEFAULT '0'";
		$db->setQuery($query);
		$db->execute();

		$query = "ALTER TABLE #__k2_attachments CHANGE `filename` `filename` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''";
		$db->setQuery($query);
		$db->execute();

		$query = "ALTER TABLE #__k2_attachments CHANGE `title` `title` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''";
		$db->setQuery($query);
		$db->execute();

		$query = "ALTER TABLE #__k2_attachments CHANGE `titleAttribute` `titleAttribute` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''";
		$db->setQuery($query);
		$db->execute();
		...
		$query = "ALTER TABLE #__k2_items CHANGE `created` `created` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00'";
		$db->setQuery($query);
		$db->execute();

		$query = "ALTER TABLE #__k2_items CHANGE `checked_out_time` `checked_out_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00'";
		$db->setQuery($query);
		$db->execute();

		$query = "ALTER TABLE #__k2_items CHANGE `modified` `modified` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00'";
		$db->setQuery($query);
		$db->execute();

		$query = "ALTER TABLE #__k2_items CHANGE `publish_up` `publish_up` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00'";
		$db->setQuery($query);
		$db->execute();

		$query = "ALTER TABLE #__k2_items CHANGE `publish_down` `publish_down` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00'";
		$db->setQuery($query);
		$db->execute();
		...
		$query = "ALTER TABLE #__k2_comments CHANGE `commentDate` `commentDate` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00'";
		$db->setQuery($query);
		$db->execute();
